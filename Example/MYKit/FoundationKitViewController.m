//
//  FoundationKitViewController.m
//  MYKitDemo
//
//  Created by QMMac on 2018/8/7.
//  Copyright © 2018 com.51fanxing. All rights reserved.
//

#import "FoundationKitViewController.h"
#import "MYKitMacroHeader.h"

@interface FoundationKitViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation FoundationKitViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.title = @"FoundationKit";
    self.view.backgroundColor = [UIColor whiteColor];
    
    [self.dataSource addObject:@"*FoundationKit之Date*-MYDateViewController"];
